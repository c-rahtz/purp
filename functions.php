...
function purp_scripts() {
	...
	wp_enqueue_script( 'three-js', get_template_directory_uri() . '/js/three.min.js', array(), '201701', true);
	...
	wp_enqueue_script( 'purp-header-animation', get_template_directory_uri() . '/js/header-animation-simple.js', array(), '20170123', true);
